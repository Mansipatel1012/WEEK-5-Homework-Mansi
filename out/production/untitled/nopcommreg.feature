Feature: Nopcommerce Registration
  ...
  Scenario Outline: I should not be able to register with invalid data on mandatory field (*) of registration page
    ...
    Examples:
      ...
      |""	     | patel    |XYZ@gmail.com |123456  |123456             |please enter First Name     			   |
      |Mansi	 |""	    |XYZ@gmail.com |123456  |123456  	        |please enter Last Name      			   |
      |Mansi     | patel    |""			   |123456  |123456 	        |please enter valid email   			   |
      |Mansi	 | patel    |XYZ@gmail.com |""      |123456		        |password is required              		   |
      |Mansi     | patel    |XYZ@gmail.com |123456  |""			        |confirm password is required              |
      |Mansi     | patel    |XYZ@gmail.com |123456  |12345		        |password and confirm password do not match|
      |Mansi     | patel    |XYZ@gmail.com |123456  |""  			    |minimum 6 character password is required  |
  ...
  Scenario: I should be able to register with valid mandatory (*) field data on registration page
    When 	I enter First name "Mansi"
    And	 	I enter Last name "Patel"
    And 	I enter Email "Mansi@gmail.com"
